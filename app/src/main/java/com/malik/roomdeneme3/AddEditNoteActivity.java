...
public class AddEditNoteActivity extends AppCompatActivity {
    public static final String EXTRA_ID = "com.malik.roomdeneme3.EXTRA_ID";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.note_ic_close);

        Intent intent = getIntent();
        if (intent.hasExtra(EXTRA_ID)) {
            setTitle("Edit Note");
            editTextTitle.setText(intent.getStringExtra(EXTRA_TITLE));
            editTextDescription.setText(intent.getStringExtra(EXTRA_DESCRIPTON));
